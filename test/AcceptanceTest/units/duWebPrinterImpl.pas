...
begin
  ...
  FDriver.Params.VatRates.Add(3, 15,  'ÍÄÑ 15%');
end;
...
begin
  ...
  FptrCheck(Driver.PrintRecItem('Item 1', 100, 1000, 0, 100, 'øò'));
  FptrCheck(Driver.DirectIO2(DIO_SET_ITEM_CLASS_CODE, 0, '04811001001000000'));

  FptrCheck(Driver.PrintRecItem('Item 2', 100, 1000, 1, 100, 'øò'));
  FptrCheck(Driver.DirectIO2(DIO_SET_ITEM_CLASS_CODE, 0, '04811001001000000'));

  FptrCheck(Driver.PrintRecItem('Item 3', 100, 1000, 2, 100, 'øò'));
  FptrCheck(Driver.DirectIO2(DIO_SET_ITEM_CLASS_CODE, 0, '04811001001000000'));
  
  FptrCheck(Driver.PrintRecItem('Item 4', 100, 1000, 3, 100, 'øò'));
  FptrCheck(Driver.DirectIO2(DIO_SET_ITEM_CLASS_CODE, 0, '04811001001000000'));
