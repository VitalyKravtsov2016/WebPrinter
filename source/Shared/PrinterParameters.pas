...
type
  ...
  private
    ...
    FSalesAmountCash: Currency; // Âñåãî ïðîäàæ íàëè÷íûå
    FSalesAmountCard: Currency; // Âñåãî ïðîäàæ áàíêîâñêèå êàðòû
    FRefundAmountCash: Currency; // Âñåãî âîçâðàòîâ íàëè÷íûå
    FRefundAmountCard: Currency; // Âñåãî âîçâðàòîâ áàíêîâñèå êàðòû

    procedure SetMessageLength(const Value: Integer);
  public
    CashInECRAutoZero: Boolean;
    SalesAmountCashLine: WideString; // Âñåãî ïðîäàæ íàëè÷íûå
    SalesAmountCardLine: WideString; // Âñåãî ïðîäàæ áàíêîâñêèå êàðòû
    RefundAmountCashLine: WideString; // Âñåãî âîçâðàòîâ íàëè÷íûå
    RefundAmountCardLine: WideString; // Âñåãî âîçâðàòîâ áàíêîâñèå êàðòû
...
begin
  ...
  ItemUnits.Add(3, 'ìèëëèãðàìì');
  ItemUnits.Add(4, 'ãðàìì');
  ItemUnits.Add(5, 'êèëîãðàìì');
  ItemUnits.Add(6, 'öåíòíåð');
  ItemUnits.Add(7, 'òîííà');
  ItemUnits.Add(8, 'ìèëëèìåòð');
  ItemUnits.Add(9, 'ñàíòèìåòð');
  ItemUnits.Add(11, 'ìåòð');
  ItemUnits.Add(12, 'êèëîìåòð');
  ItemUnits.Add(22, 'ìèëëèëèòð');
  ItemUnits.Add(23, 'ëèòð');
  ItemUnits.Add(26, 'êîìïëåêò');
  ItemUnits.Add(27, 'ñóòêè');
  ItemUnits.Add(28, '÷àñ');
  ItemUnits.Add(33, 'êîðîáêà');
  ItemUnits.Add(38, 'óïàêîâêà');
  ItemUnits.Add(39, 'ìèíóò');
  ItemUnits.Add(41, 'áàëëîí');
  ItemUnits.Add(42, 'äåíü');
  ItemUnits.Add(43, 'ìåñÿö');
  ItemUnits.Add(49, 'ðóëîí');

  CashinLine := 'ÂÍÅÑÅÍÎ';
  CashinPreLine := 'ÒÈÏ ÎÏÅÐÀÖÈÈ: ÂÍÅÑÅÍÈÅ';
  CashinPostLine := '';

  CashoutLine := 'ÈÇÚßÒÎ';
  CashoutPreLine := 'ÒÈÏ ÎÏÅÐÀÖÈÈ: ÈÇÚßÒÈÅ';
  CashoutPostLine := '';
  CashInAmount := 0;
  CashOutAmount := 0;
  ...
  SalesAmountCashLine := 'ÂÑÅÃÎ ÏÐÎÄÀÆ ÍÀËÈ×ÍÛÅ';
  SalesAmountCardLine := 'ÂÑÅÃÎ ÏÐÎÄÀÆ ÁÀÍÊÎÂÑÊÈÅ ÊÀÐÒÛ';
  RefundAmountCashLine := 'ÂÑÅÃÎ ÂÎÇÂÐÀÒÎÂ ÍÀËÈ×ÍÛÅ';
  RefundAmountCardLine := 'ÂÑÅÃÎ ÂÎÇÂÐÀÒÎÂ ÁÀÍÊÎÂÑÊÈÅ ÊÀÐÒÛ';
end;
