...
type
  ...
  TFiscalPrinterImpl = class(TComponent)
  private
    FRetalix: TRetalix;
    FService: TFSService;
    FFilter: TEscFilter;
...
function TFiscalPrinterImpl.GetSystemLocaleStr: WideString;
const
...
function TFiscalPrinterImpl.GetSystemVersionStr: WideString;
var
