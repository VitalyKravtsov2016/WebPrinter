...
const
  ...
  SMFPTR_CASHREG_DAY_TOTAL_SALE_CASH      = 1014;
  SMFPTR_CASHREG_DAY_TOTAL_SALE_CARD      = 1015;
  SMFPTR_CASHREG_DAY_TOTAL_RETSALE_CASH   = 1016;
  SMFPTR_CASHREG_DAY_TOTAL_RETSALE_CARD   = 1017;
  SMFPTR_CASHREG_GRAND_TOTAL_SALE_CASH    = 1018;
  SMFPTR_CASHREG_GRAND_TOTAL_SALE_CARD    = 1019;
  SMFPTR_CASHREG_GRAND_TOTAL_RETSALE_CASH = 1020;
  SMFPTR_CASHREG_GRAND_TOTAL_RETSALE_CARD = 1021;
...
const
  ...
  DIO_SET_RECEIPT_JSON_FIELD      = 105;
  DIO_SET_RECITEM_JSON_FIELD      = 106;
